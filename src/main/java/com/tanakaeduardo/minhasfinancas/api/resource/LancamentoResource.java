package com.tanakaeduardo.minhasfinancas.api.resource;
...
import com.tanakaeduardo.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.tanakaeduardo.minhasfinancas.api.dto.LancamentoDTO;
...
import com.tanakaeduardo.minhasfinancas.model.enums.TipoLancamento;
import com.tanakaeduardo.minhasfinancas.service.LancamentoService;
	...
	public ResponseEntity atualizarStatus( @PathVariable("id") Long id, @RequestBody AtualizaStatusDTO dto) {
		return service.obterPorId(id).map( entity -> {
			...
			if(statusSelecionado == null) {
				return ResponseEntity.badRequest().body("Não foi possivel atualizar o status do lancamento, envie");
			}
			try {
